...
MockInterceptor.onGet("/api/scrum-board/all-member").reply(config => {
  return [200, [...ScrumBoardDB.members]];
});

MockInterceptor.onGet("/api/scrum-board/all-label").reply(config => {
  return [200, [...ScrumBoardDB.labels]];
});

MockInterceptor.onGet("/api/scrum-board/all-board").reply(config => {
...
MockInterceptor.onPost("/api/scrum-board/add-board").reply(config => {
...
MockInterceptor.onGet("/api/scrum-board").reply(config => {
...
MockInterceptor.onPost("/api/scrum-board/add-member").reply(config => {
...
MockInterceptor.onPost("/api/scrum-board/delete-member").reply(config => {
  let { boardId, memberId } = JSON.parse(config.data);
...
MockInterceptor.onPost("/api/scrum-board/add-column").reply(config => {
...
MockInterceptor.onPost("/api/scrum-board/rename-column").reply(config => {
...
MockInterceptor.onPost("/api/scrum-board/delete-column").reply(config => {
...
MockInterceptor.onPost("/api/scrum-board/add-card").reply(config => {
...
MockInterceptor.onPost("/api/scrum-board/update-card").reply(config => {
...
MockInterceptor.onPost("/api/scrum-board/reorder-list").reply(config => {
...
MockInterceptor.onPost("/api/scrum-board/reorder-card").reply(config => {
...
MockInterceptor.onPost("/api/scrum-board/move-card").reply(config => {
  let {
    boardId,
    sourcelistId,
    destinationlistId,
